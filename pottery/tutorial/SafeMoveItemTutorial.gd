...
func play_animation():
	...
	$Mouse/ShiftKey.visible = false
	tween = create_tween()
	tween.tween_property($Mouse, "position", $MouseClickPos.position, 0.7).set_delay(0.3)
	tween.tween_property($Mouse, "texture", preload("res://art/mouse_left.png"), 0)
	tween.set_parallel(true)
	tween.tween_property($Mouse, "position", $MouseClickPos.position - ($Piece2.position - $Piece1.position), 1.0).set_delay(0.5)
	tween.tween_property($Piece2, "position", $Piece1.position, 1.0).set_delay(0.5)
	tween.set_parallel(false)
	tween.tween_property($ClinkEffect, "visible", true, 0)
	...
	tween.tween_property($ClinkEffect, "visible", false, 0)
	...
	tween.tween_property($Mouse, "position", $MouseClickPos.position, 0.7).set_delay(0.3)
	tween.tween_property($Mouse, "texture", preload("res://art/mouse_left.png"), 0)
	tween.tween_property($Mouse/ShiftKey, "visible", true, 0)
	tween.tween_property($Piece2, "modulate", Color(0.2, 0.2, 0.2), 0)
	tween.set_parallel(true)
	tween.tween_property($Mouse, "position", $MouseClickPos.position - ($Piece2.position - $MouseDragPos2.position), 2.0).set_delay(0.5)
	tween.tween_property($Piece2, "position", $MouseDragPos2.position, 2.0).set_delay(0.5)
	tween.set_parallel(false)
	tween.tween_property($Mouse, "texture", preload("res://art/mouse_none.png"), 0).set_delay(0.5)
	tween.tween_property($Mouse/ShiftKey, "visible", false, 0)
	tween.tween_property($Piece2, "modulate", Color(0, 0, 0), 0)
	tween.tween_property($Mouse, "texture", preload("res://art/mouse_none.png"), 0).set_delay(1.0)
